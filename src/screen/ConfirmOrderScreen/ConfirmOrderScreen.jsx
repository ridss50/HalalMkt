...
const ConfirmOrderScreen = props => {
  ...
  const lCost =
    parseFloat(lambQty) *
    parseFloat(VendorReducer.stock[0].LambCost);
  const gCost =
    parseFloat(goatQty) *
    parseFloat(VendorReducer.stock[0].GoatCost);
  const cCost =
    parseFloat(cowQty) * parseFloat(VendorReducer.stock[0].CowCost);
  const csCost =
    parseFloat(cowShareQty) *
    parseFloat(VendorReducer.stock[0].CowShareCost);
